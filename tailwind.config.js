    ...
    theme: {
        extend: {
            ...
            textColor: {
                ...
                "fg-secondary--hover": generateColorClass("sv-text-fg-secondary--hover"),
            ...
            backgroundColor: {
                ...
                "light-primary--hover": generateColorClass("sv-bg-light-primary--hover"),
                "light-primary--active": generateColorClass("sv-bg-light-primary--active"),
                ...
                "light-secondary--hover": generateColorClass("sv-bg-light-secondary--hover"),
                "light-secondary--active": generateColorClass("sv-bg-light-secondary--active"),
                ...
                "light-success--hover": generateColorClass("sv-bg-light-success--hover"),
                "light-success--active": generateColorClass("sv-bg-light-success--active"),
                ...
                "light-danger--active": generateColorClass("sv-bg-light-danger--active"),
                ...
                "light-warning--hover": generateColorClass("sv-bg-light-warning--hover"),
                "light-warning--active": generateColorClass("sv-bg-light-warning--active"),
