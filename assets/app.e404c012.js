...
var serializedSiteData = '{"lang":"en-US","title":"Shuttle Vue","description":"Shuttle Vue 3 UI components built with Tailwind.","base":"/shuttle-vue3/","head":[],"themeConfig":{"socialLinks":[{"icon":"github","link":"https://github.com/shuttle-npm/shuttle-vue3"}],"nav":[{"text":"Components","activeMatch":"^/components/","link":"/components/overview"}],"sidebar":{"/components/":[{"text":"Components","items":[{"text":"Alert","link":"/components/alert"},{"text":"Busy","link":"/components/busy"},{"text":"Button","link":"/components/button"},{"text":"Button Group","link":"/components/button-group"},{"text":"Checkbox","link":"/components/checkbox"},{"text":"Dialog","link":"/components/dialog"},{"text":"Form","link":"/components/form"},{"text":"Input","link":"/components/input"},{"text":"Listbox","link":"/components/listbox"},{"text":"Navbar","link":"/components/navbar"},{"text":"Navigation","link":"/components/navigation"},{"text":"Strip","link":"/components/strip"},{"text":"Table","link":"/components/table"},{"text":"Title","link":"/components/title"},{"text":"Toggle","link":"/components/toggle"}]},{"text":"Essentials","items":[{"text":"Core Class Objects","link":"/components/core-class"}]}]}},"locales":{},"langs":{},"scrollOffset":90}';
...
const _sfc_main$w = /* @__PURE__ */ defineComponent({
  setup(__props) {
    const { theme } = useData();
    const VPAlgoliaSearchBox = defineAsyncComponent(() => import("./chunks/VPAlgoliaSearchBox.9302bcf3.js"));
    const loaded = ref(false);
    const metaKey = ref();
    onMounted(() => {
...
export { onUnmounted as A, h as B, reactive as C, onUpdated as D, cloneVNode as E, Fragment as F, nextTick as G, withModifiers as H, Transition as I, VTIconDiscord as J, useData as K, useRoute as L, useRouter as M, Teleport as T, VTIconShuttle as V, _export_sfc as _, createVNode as a, createElementBlock as b, createBlock as c, createApp, createCommentVNode as d, ref as e, computed as f, createBaseVNode as g, createTextVNode as h, createStaticVNode as i, resolveDynamicComponent as j, renderSlot as k, withKeys as l, mergeProps as m, normalizeClass as n, openBlock as o, defineComponent as p, watch as q, renderList as r, provide as s, toDisplayString as t, unref as u, onMounted as v, withCtx as w, watchEffect as x, inject as y, toRaw as z };
