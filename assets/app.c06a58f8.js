...
const _sfc_main$w = /* @__PURE__ */ defineComponent({
  setup(__props) {
    const { theme } = useData();
    const VPAlgoliaSearchBox = defineAsyncComponent(() => import("./chunks/VPAlgoliaSearchBox.f8dd81dd.js"));
    const loaded = ref(false);
    const metaKey = ref();
    onMounted(() => {
...
export { onUnmounted as A, h as B, Teleport as C, reactive as D, onUpdated as E, Fragment as F, cloneVNode as G, nextTick as H, withModifiers as I, Transition as J, useData as K, useRoute as L, useRouter as M, TransitionGroup as T, VTIconShuttle as V, _export_sfc as _, createVNode as a, createElementBlock as b, createBlock as c, createApp, createCommentVNode as d, ref as e, computed as f, createBaseVNode as g, createTextVNode as h, createStaticVNode as i, resolveDynamicComponent as j, renderSlot as k, withKeys as l, mergeProps as m, normalizeClass as n, openBlock as o, watch as p, onMounted as q, renderList as r, defineComponent as s, toDisplayString as t, unref as u, provide as v, withCtx as w, watchEffect as x, inject as y, toRaw as z };
