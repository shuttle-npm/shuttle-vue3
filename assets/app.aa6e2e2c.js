...
const _sfc_main$w = /* @__PURE__ */ defineComponent({
  setup(__props) {
    const { theme } = useData();
    const VPAlgoliaSearchBox = defineAsyncComponent(() => import("./chunks/VPAlgoliaSearchBox.3277ad28.js"));
    const loaded = ref(false);
    const metaKey = ref();
    onMounted(() => {
...
export { h as A, reactive as B, onUpdated as C, cloneVNode as D, nextTick as E, Fragment as F, Transition as G, useData as H, useRoute as I, useRouter as J, Teleport as T, VTIconShuttle as V, _export_sfc as _, createVNode as a, createElementBlock as b, createBlock as c, createApp, createCommentVNode as d, ref as e, createBaseVNode as f, createTextVNode as g, createStaticVNode as h, resolveDynamicComponent as i, renderSlot as j, defineComponent as k, computed as l, mergeProps as m, normalizeClass as n, openBlock as o, watch as p, provide as q, renderList as r, onMounted as s, toDisplayString as t, unref as u, watchEffect as v, withCtx as w, inject as x, toRaw as y, onUnmounted as z };
