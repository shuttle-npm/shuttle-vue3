...
const _hoisted_5 = /* @__PURE__ */ createStaticVNode('<section id="highlights" class="vt-box-container" data-v-185d2273><div class="vt-box" data-v-185d2273><h2 data-v-185d2273>Components</h2><div data-v-185d2273>The most common use-cases are covered.</div></div><div class="vt-box" data-v-185d2273><h2 data-v-185d2273>Why?</h2><div data-v-185d2273>These components are for developing Shuttle based web applications. You are welcome to use them and assist in extending the framework.</div></div><div class="vt-box" data-v-185d2273><h2 data-v-185d2273>Open Source</h2><div data-v-185d2273> These packages are free open source software licensed under the <a href="https://opensource.org/licenses/BSD-3-Clause" data-v-185d2273>3-Clause BSD License</a>. Pull requests are welcome. </div></div></section>', 1);
const _sfc_main$1 = {
  setup(__props) {
    return (_ctx, _cache) => {
