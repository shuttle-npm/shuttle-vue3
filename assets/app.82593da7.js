...
var serializedSiteData = '{"lang":"en-US","title":"Shuttle Vue","description":"Shuttle Vue 3 UI components built with Tailwind.","base":"/shuttle-vue3/","head":[],"themeConfig":{"socialLinks":[{"icon":"github","link":"https://github.com/shuttle-npm/shuttle-vue3"}],"nav":[{"text":"Components","activeMatch":"^/components/","link":"/components/overview"}],"sidebar":{"/components/":[{"text":"Components","items":[{"text":"Alerts","link":"/components/alerts"},{"text":"Buttons","link":"/components/buttons"},{"text":"Checkbox","link":"/components/checkbox"},{"text":"Dialog","link":"/components/dialog"},{"text":"Input","link":"/components/input"},{"text":"Listbox","link":"/components/listbox"},{"text":"Navbar","link":"/components/navbar"},{"text":"Navigation","link":"/components/navigation"},{"text":"Title","link":"/components/title"},{"text":"Toggle","link":"/components/toggle"}]},{"text":"Essentials","items":[{"text":"Core Class Objects","link":"/components/core-class"}]}]}},"locales":{},"langs":{},"scrollOffset":90}';
...
const _sfc_main$w = /* @__PURE__ */ defineComponent({
  setup(__props) {
    const { theme } = useData();
    const VPAlgoliaSearchBox = defineAsyncComponent(() => import("./chunks/VPAlgoliaSearchBox.024ce377.js"));
    const loaded = ref(false);
    const metaKey = ref();
    onMounted(() => {
