...
const _sfc_main$w = /* @__PURE__ */ defineComponent({
  setup(__props) {
    const { theme } = useData();
    const VPAlgoliaSearchBox = defineAsyncComponent(() => import("./chunks/VPAlgoliaSearchBox.f937cc93.js"));
    const loaded = ref(false);
    const metaKey = ref();
    onMounted(() => {
...
export { onUnmounted as A, h as B, reactive as C, onUpdated as D, cloneVNode as E, Fragment as F, nextTick as G, withModifiers as H, Transition as I, useData as J, useRoute as K, useRouter as L, Teleport as T, VTIconShuttle as V, _export_sfc as _, createVNode as a, createElementBlock as b, createBlock as c, createApp, createCommentVNode as d, ref as e, createBaseVNode as f, createTextVNode as g, createStaticVNode as h, resolveDynamicComponent as i, renderSlot as j, withCtx as k, defineComponent as l, mergeProps as m, normalizeClass as n, openBlock as o, computed as p, watch as q, renderList as r, provide as s, toDisplayString as t, unref as u, onMounted as v, withKeys as w, watchEffect as x, inject as y, toRaw as z };
